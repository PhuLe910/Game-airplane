...
public class Player extends HpRender{
    ...
    public Player() {
        super(new HP(50, 50));
        this.image = new ImageIcon(getClass().getResource("/game/image/airplane2.png")).getImage();
        this.image_speed = new ImageIcon(getClass().getResource("/game/image/airplane.png")).getImage();
        Path2D p = new Path2D.Double();
        int OBSET_X = -17;
        int OBSET_Y = 0;
        p.moveTo(0 + OBSET_X, 15 + OBSET_Y);
        p.lineTo(20 + OBSET_X, 5 + OBSET_Y);
        p.lineTo(PLAYER_SIZE + 15 + OBSET_X, PLAYER_SIZE  / 2 + OBSET_Y);
        p.lineTo(20 + OBSET_X, PLAYER_SIZE - 5 + OBSET_Y);
        p.lineTo(0 + OBSET_X, PLAYER_SIZE - 15 + OBSET_Y);
