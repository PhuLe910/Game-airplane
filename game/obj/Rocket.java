...
public class Rocket extends HpRender {
    ...
    public Rocket() {
        ...
        p.moveTo(0 + OBSET_X , ROCKET_SIZE / 2 + OBSET_Y);
        p.lineTo(15 + OBSET_X , 10 + OBSET_Y);
        p.lineTo(ROCKET_SIZE - 5 + OBSET_X , 13 + OBSET_Y);
        p.lineTo(ROCKET_SIZE + 10 + OBSET_X , ROCKET_SIZE / 2 + OBSET_Y);
        p.lineTo(ROCKET_SIZE - 5 + OBSET_X , ROCKET_SIZE - 13 + OBSET_Y);
        p.lineTo(15 + OBSET_X , ROCKET_SIZE - 10 + OBSET_Y);
